...
/**
  ...
  /**
   * `prisma.departureTime`: Exposes CRUD operations for the **DepartureTime** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more DepartureTimes
    * const departureTimes = await prisma.departureTime.findMany()
    * ```
    */
  get departureTime(): Prisma.DepartureTimeDelegate<ExtArgs, { omit: OmitOpts }>;

  /**
   * `prisma.winnerHistory`: Exposes CRUD operations for the **WinnerHistory** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more WinnerHistories
    * const winnerHistories = await prisma.winnerHistory.findMany()
    * ```
    */
  get winnerHistory(): Prisma.WinnerHistoryDelegate<ExtArgs, { omit: OmitOpts }>;
