import { D as DriverAdapterError, C as ColumnTypeEnum } from "./driver-adapter-utils.mjs";
import pg2 from "pg";
import { p as postgresArrayExports } from "../../../_libs/postgres-array.mjs";
...
function normalize_array(element_normalizer) {
  return (str) => postgresArrayExports.parse(str, element_normalizer);
}
